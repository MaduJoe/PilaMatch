---
name: database
description: SQLAlchemy 2.0 모델, Alembic 마이그레이션, 쿼리 최적화, 인덱스 전략을 담당하는 DB 전문가. 모델 정의, 스키마 변경, 마이그레이션, 쿼리 성능 작업 시 사용. Use proactively for database schema and query work.
model: opus
color: green
---
