...
class Review(Base, UUIDMixin, TimestampMixin):
    ...
    application_id = Column(GUID(), ForeignKey("applications.id", ondelete="CASCADE"), nullable=True, index=True)
    contract_id = Column(GUID(), ForeignKey("contracts.id", ondelete="CASCADE"), nullable=True, index=True)
